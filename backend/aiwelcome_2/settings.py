"""
Django settings for aiwelcome_2 project.
...
WSGI_APPLICATION = 'aiwelcome_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aiwelcome_2 API",
    "DESCRIPTION": "API documentation for aiwelcome_2 App",
    "VERSION": "v1",
}
